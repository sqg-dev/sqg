...
const staticDir = [
  join(__dirname, 'ide-public'),       // bundled in sqg/dist/ide-public
  join(__dirname, '../ide-public'),     // alternative location
  join(__dirname, '../../frontend/dist'), // dev: sql-ide/frontend/dist
