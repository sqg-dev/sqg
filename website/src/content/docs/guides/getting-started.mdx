...
|--------|-------------|------------|------|
| `sqlite` | Embedded, no server required | [typescript/sqlite](/generators/typescript-sqlite/) | [java/sqlite](/generators/java-jdbc/) |
| `duckdb` | Analytics, complex types | [typescript/duckdb](/generators/typescript-duckdb/) | [java/duckdb](/generators/java-jdbc/), [java/duckdb/arrow](/generators/java-duckdb-arrow/) |
| `postgres` | Full-featured SQL server | — | [java/postgres](/generators/java-jdbc/) |
