...
import { JavaGenerator } from '../src/generator';
...
describe('JavaGenerator', () => {
  ...
  describe('getClassName', () => {
    it('should convert to PascalCase', () => {
      ...
      expect(generator.getClassName('CREATE_USER_RESULT')).toMatchInlineSnapshot(`"CreateUserResult"`);
  ...
  describe('listType', () => {
    it('should wrap type in List<>', () => {
      expect(generator.listType({name: 'test', type: 'varchar', nullable: false})).toMatchInlineSnapshot(`"List<String>"`);
      expect(generator.listType({name: 'test', type: 'integer', nullable: false})).toMatchInlineSnapshot(`"List<Integer>"`);
      expect(generator.listType({name: 'user', type: new ColumnTypeStruct([]), nullable: false})).toMatchInlineSnapshot(`"List<UserResult>"`);
    });
  });
