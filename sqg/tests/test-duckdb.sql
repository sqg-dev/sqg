...
select ['a','b', 'c'] as names
 ...
 -- QUERY testList2 :pluck 

select ['a','b', 'c'] as names

-- QUERY testList3 :pluck :one
...
-- QUERY testStruct2 :pluck

select data: {'test' : 1, 'name' : 'abc', 'nested' : {'test' : true}}

-- QUERY testStruct3 :pluck :one

select data: {'test' : 1, 'name' : 'abc', 'nested' : {'test' : true}}

-- QUERY testStruct4 :one

select data: {'test' : 1, 'name' : 'abc', 'nested' : {'test' : true}}


-- QUERY testNestedStructs :one
...
-- QUERY testNested2 :one

select {'x' : [{'a' : 1}]} as data
-- select x:1;


-- QUERY testNested3 :one
select a:[1,2,3] ,b:2, c: {'x' : [{'a' : 1}], 'y' : {'z' : 3}}


-- Q UERY testArrayOfArrays :one
-- select a:[[1],[2,3], [1,2,3]]


-- Q UERY testArrayOfArrays2 :one
-- select a:[[[1]],[[2]], [[3]]]